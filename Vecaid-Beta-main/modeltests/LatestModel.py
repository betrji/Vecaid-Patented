...
def composite_indicator_signal(latest, data=None):
    """
    Combine many signals, with capping and optional short-window/regime detection.
    """
    def capped(val):
...
def technical_signal(latest):
    ...
    # Add base composite with no data context
...
def train_ml_model(ticker, window=60):
    ...
    # FIX: Flatten daily_data if its columns are a MultiIndex.
    ...
    # Even if intraday_agg is empty, we can proceed
    ...
    # Ensemble of XGBoost predictions
